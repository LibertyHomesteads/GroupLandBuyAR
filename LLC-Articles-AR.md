...
8. **Subvidision compliance:** In order to comply fully with MO Rev Stat § 71.270 (2021), the LLC is hereby forbidden from (1) subdividing land to sell individual lots via tenency-in-common or outright, and (2) Recording any interior features of the property on the recorded plat in the county land authority.  
